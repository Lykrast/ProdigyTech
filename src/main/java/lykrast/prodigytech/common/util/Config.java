...
public class Config {
	...
	private static void initGeneralConfig(Configuration cfg) {
		...
		crystalGrowthChamberProcessTime = cfg.getInt("crystalGrowthChamberProcessTime", CATEGORY_MACHINES, 120, 1, 1500, 
				"The base amount of time (in SECONDS) that the Crystal Growth Chamber takes to grow a Cluster");
		crystalGrowthChamberMaxDesync = cfg.getInt("crystalGrowthChamberMaxDesync", CATEGORY_MACHINES, 1000, 1, 30000, 
