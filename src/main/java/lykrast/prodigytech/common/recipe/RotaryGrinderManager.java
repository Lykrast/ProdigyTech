...
public class RotaryGrinderManager extends SimpleRecipeManager {
	...
	public void init()
	{
		...
		if (RecipeUtil.oreExists("dust")) addRecipe("sand", RecipeUtil.getPreferredOreStack("dust"));
		if (RecipeUtil.itemExists("exnihilocreatio:block_netherrack_crushed")) addRecipe("netherrack", new ItemStack(RecipeUtil.getExteriorItem("exnihilocreatio:block_netherrack_crushed")));
		if (RecipeUtil.itemExists("exnihilocreatio:block_endstone_crushed")) addRecipe("endstone", new ItemStack(RecipeUtil.getExteriorItem("exnihilocreatio:block_endstone_crushed")));
		if (RecipeUtil.oreExists("crushedGranite")) addRecipe("stoneGranite", RecipeUtil.getPreferredOreStack("crushedGranite"));
		if (RecipeUtil.oreExists("crushedDiorite")) addRecipe("stoneDiorite", RecipeUtil.getPreferredOreStack("crushedDiorite"));
		if (RecipeUtil.oreExists("crushedAndesite")) addRecipe("stoneAndesite", RecipeUtil.getPreferredOreStack("crushedAndesite"));
