...
public class ContainerCapacitorCharger extends ContainerMachine<TileCapacitorCharger> {
    private int temperature;
    private int progressCycle;
    private int targetTemperature;
    
	public ContainerCapacitorCharger(InventoryPlayer userInv, TileCapacitorCharger tile) {
		super(tile);
