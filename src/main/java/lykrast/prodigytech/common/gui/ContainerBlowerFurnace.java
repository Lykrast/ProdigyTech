...
public class ContainerBlowerFurnace extends ContainerMachine<TileBlowerFurnace> {
    private int temperature;
    private int temperatureOut;
    private int processTime;
    private int processTimeMax;
    
	public ContainerBlowerFurnace(InventoryPlayer userInv, TileBlowerFurnace tile) {
		super(tile);
